...
<body>
	<div class="layout">
		...
		<main class="index">
			...
			<section class="promo-img js-promo">
				<img src="../images/userfiles/about-bg.jpg" alt="">
			</section>

			<div class="after-promo js-after-promo">
				...
				<section class="philosophy bg--lime js-scroll-trigger">
					<div class="wr" 
				...
				<section class="team">
					<div class="wr">
						...
						<div class="team__row">
							<div class="team__item  js-scroll-trigger">
