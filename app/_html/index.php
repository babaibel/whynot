					...
					<div class="index-cards__row">
						<a class="card" href="#!">
							<div class="card__top">
								...
								<div class="card__title">Катание на багги «Экстрим под рев мотора»</div>
						...
						<a class="card" href="#!">
							<div class="card__top">
								...
								<div class="card__title">Посещение Эко хаски Парка в Сокольниках</div>
								<div class="card__text">Вам не хватает скорости и острых ощущений? За десять минут вы зарядитесь мощной дозой адреналина и сполна </div>
							</div>
							<div class="card__bottom">
								<div class="card__date"><span class="icon iconic--calendar"></span>16 января, 11:00–19:00</div>
						...
						<a class="card" href="#!">
							<div class="card__top">
								...
								<div class="card__title">Катание на багги </div>
								<div class="card__text">Вам не хватает скорости и острых ощущений? За десять минут вы зарядитесь мощной дозой адреналина и сполна </div>
							</div>
							<div class="card__bottom">
								<div class="card__date"><span class="icon iconic--calendar"></span>16 января, 11:00–19:00</div>
			...
			<section class="index-map">
				<div class="wr">
					<div class="title-header">
						...
						<a href="#!" class="btn btn--fix-h btn--white btn--icon">
						<span class="icon iconic--target"></span>Определить мое местоположение
						</a>
					</div>
				</div>
				<div class="index-map__container" id="js-index-map"></div>
			</section>
					...
					<div class="about-cols">
						...
						<div class="about-cols__item">
							...
							<div class="about-cols__inner">
								...
								<div class="about-cols__text">
									Запомним, что вам нравится, и оповестим об новых мероприятиях. Просто <a class="link-underline link-underline--green-d" href="#">подпишитесь на нашу рассылку</a>. Никакого спама. Только по делу.
								</div>
							</div>
						</div>
					</div>
